...
void RBTree::update(Data old_d, Data new_d)
{
    remove(old_d);
    insert(new_d);
}
...
Node* RBTree::deleteBST(Node *&root, Data data)
{
    if (root == nullptr)
        return root;
